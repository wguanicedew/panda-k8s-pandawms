...
# /sdf/group/rubin/sandbox/panda_env/runpilot2-wrapper_20220412.sh -s SLAC_Rubin -r SLAC_Rubin -q SLAC_Rubin -j managed -i PR -w generic --allow-same-user false --pilot-user rubin --noproxyverification --url https://pandaserver-doma.cern.ch -d --harvester-submit-mode PULL --queuedata-url http://pandaserver-doma.cern.ch:25080/cache/schedconfig/SLAC_Rubin.all.json --storagedata-url https://datalake-cric.cern.ch/api/atlas/ddmendpoint/query/?json  --use-realtime-logging --realtime-logging-server google-cloud-logging --realtime-logname Panda-RubinLog --pilotversion 3  --pythonversion 3 --localpy

# /sdf/group/rubin/sandbox/panda_env/runpilot2-wrapper_20220412.sh -s {computingSite} -r {computingSite} -q {pandaQueueName} -i PR -w generic --allow-same-user false --pilot-user rubin --noproxyverification --url https://pandaserver-doma.cern.ch -d --harvester-submit-mode {submitMode} --queuedata-url http://pandaserver-doma.cern.ch:25080/cache/schedconfig/{computingSite}.all.json --storagedata-url https://datalake-cric.cern.ch/api/atlas/ddmendpoint/query/?json --use-realtime-logging --realtime-logging-server google-cloud-logging --realtime-logname Panda-RubinLog --pilotversion 3  --pythonversion 3 --localpy


# /sdf/group/rubin/sandbox/panda_env_pilot/rubin-wrapper.sh -s {computingSite} -r {computingSite} -q {pandaQueueName} -i PR -w generic --allow-same-user false --pilot-user rubin --noproxyverification --url https://pandaserver-doma.cern.ch -d --harvester-submit-mode {submitMode} --queuedata-url http://pandaserver-doma.cern.ch:25080/cache/schedconfig/{computingSite}.all.json --storagedata-url https://datalake-cric.cern.ch/api/atlas/ddmendpoint/query/?json --use-realtime-logging --realtime-logging-server google-cloud-logging --realtime-logname Panda-RubinLog --pilotversion 3  --pythonversion 3 --localpy

# /sdf/data/rubin/panda_jobs/panda_env_pilot/rubin-wrapper.sh -s {computingSite} -r {computingSite} -q {pandaQueueName} -i PR -w generic --allow-same-user false --pilot-user rubin --noproxyverification --url https://pandaserver-doma.cern.ch -d --harvester-submit-mode {submitMode} --queuedata-url http://pandaserver-doma.cern.ch:25080/cache/schedconfig/{computingSite}.all.json --storagedata-url https://datalake-cric.cern.ch/api/atlas/ddmendpoint/query/?json --use-realtime-logging --realtime-logging-server google-cloud-logging --realtime-logname Panda-RubinLog --pilotversion 3  --pythonversion 3 --localpy

# /sdf/home/l/lsstsvc1/cric/cric_ddmendpoints.json
# $rubin_wrapper -s {computingSite} -r {computingSite} -q {pandaQueueName} -i PR -w generic --allow-same-user false --pilot-user rubin --noproxyverification --url https://usdf-panda-server.slac.stanford.edu:8443 -d --harvester-submit-mode {submitMode} --queuedata-url https://usdf-panda-server.slac.stanford.edu:8443/cache/schedconfig/{computingSite}.all.json --storagedata-url /sdf/home/l/lsstsvc1/cric/cric_ddmendpoints.json --use-realtime-logging --realtime-logging-server google-cloud-logging --realtime-logname Panda-RubinLog --pilotversion 3  --pythonversion 3 --localpy

$rubin_wrapper ${piloturl} -s {computingSite} -r {computingSite} -q {pandaQueueName} -i PR -w generic --allow-same-user false --pilot-user rubin --es-executor-type fineGrainedProc --noproxyverification --url https://usdf-panda-server.slac.stanford.edu:8443  --harvester-submit-mode {submitMode} --queuedata-url https://usdf-panda-server.slac.stanford.edu:8443/cache/schedconfig/{computingSite}.all.json --storagedata-url /sdf/home/l/lsstsvc1/cric/cric_ddmendpoints.json --use-realtime-logging --realtime-logging-server "logserver='google-cloud-logging;https://google:80'" --realtime-logname Panda-RubinLog --pilotversion 3  --pythonversion 3 --localpy
